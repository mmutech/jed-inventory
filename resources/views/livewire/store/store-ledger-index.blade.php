            ...
            <div class="table-responsive text-nowrap">
                <table class="table">
                    ...
                    @if(!empty($data))
                        ...
                        <tr>
                            <td>{{ $ledger->stockCodeID->stock_code }}</td>
                            <td>{{ $ledger->stockCodeID->name }}</td>
                            <td>{{number_format($ledger->count)}}</td>
                        <td><a href="{{ url('store-ledger-show', $ledger->stock_code_id) }}"><i class="bx bx-show-alt text-primary"></i></a></td>
                        </tr>
                        @endforeach
                    @else
                        <tr>
