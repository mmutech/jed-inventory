        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <!-- Add Stock class -->
                    @if($isEditing)
                        <a href=""><i class="fa fa-plus"></i> Stock Class</a>
                    @endif
                </div>
                <div class="card-body">
                    <!-- class Table -->
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-between">
                                        <a type="button" wire:click="edit({{ $class->id }})"><i class="fa fa-pencil text-info"></i></a>
                                    </td>
                                    @endcan
                                </tr>
                                @endforeach
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">
                    <h3>{{ $isEditing ? 'Edit Stock Class' : 'Add Stock Class' }}</h3>
                </div>
                <div class="card-body">
                    <form wire:submit.prevent="{{ $isEditing ? 'update' : 'store' }}">
                        <div class="row">
                            ...
                            @endif
                            <div class="col-md-12">
                                @canany(['edit-class', 'create-class'])
