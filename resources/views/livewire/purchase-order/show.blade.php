    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="col-lg-9 col-12 mb-lg-0 mb-4">
            ...
            <div class="card-body">
                ...
                <hr class="mx-n1">
                <div class="col-sm-8">
                    <span class="fw-bolder">{{$actions->initiator_action ?? ''}} by: </span>
                    <span>{{$actions->initiatorID->name ?? ''}}</span>
                </div>
                <div class="col-sm-4">
                    <span class="fw-bolder">Date: </span>
                    <span>{{$data->purchase_order_date}}</span>
                ...
                @if(!empty($actions->recommended_action))
                    <hr class="mx-n1">
                    <div class="col-sm-8">
                    <span class="fw-bolder">{{$actions->recommended_action ?? ''}} by: </span>
                    <span>{{$actions->recommendedID->name ?? ''}}</span>
                    </div>
                    <div class="col-sm-4">
                    <span class="fw-bolder">Date: </span>
                    <span>{{$actions->date_recommended}}</span>
                    </div>
                @endif

                <!--Approval of purchase order -->
                @if(!empty($actions->approved_action))
                    <hr class="mx-n1">
                    <div class="col-sm-8">
                    <span class="fw-bolder">{{$actions->approved_action ?? ''}} by: </span>
                    <span>{{$actions->approvedID->name ?? '' }}</span>
                    </div>
                    <div class="col-sm-4">
                    <span class="fw-bolder">Date: </span>
                    <span>{{$actions->date_approved}}</span>
                    </div>
                @endif
                </div>
            </div>
        ...
        <div class="col-lg-3 col-12 invoice-actions">
            ...
            <!--Raised SRA-->
            @if($actions->approved_action == 'Approved')
        ...
        <!-- Approval Note -->
            <div class="card mb-4">
            <div class="card-body">
            @if(!empty($actions->recommended_by))
                <h6 class="fw-bolder">Recommendation Note:</h6>
                <p>{{$actions->recommend_note}}</p>
                <hr>
            @endif

            @if(!empty($actions->approved_by))
                <h6 class="fw-bolder">Approved Note:</h6>
                <p>{{$actions->approved_note}}</p>
            @endif

            @if($actions->recommended_by == 0)
                <button 
            ...
            @if(empty($actions->approved_action == 'Approved'))
            <div class="card">
