    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row invoice-add">
            ...
            <div class="col-lg-3 col-12 invoice-actions">
                <div class="card-header mb-2"> 
                    ...
                    @if(!empty($recommend->recommend_by))
                        @if(empty($hod_approval->hod_approved_by))
                            <button class="btn btn-label-primary d-grid w-100 mt-2" 
                                data-bs-toggle="offcanvas" 
                                data-bs-target="#hod-approval">
                            <span class="d-flex align-items-center justify-content-center text-nowrap">
                                <i class="bx bx-paper-plane bx-xs me-1"></i>HOD Approval</span>
                            </button>
                        @endif
                    @endif
                ...
                <!-- HOAP Approval Action -->
                @if(!empty($hod_approval->hod_approved_by))
                    @if(empty($approval->approved_by))
                    <div class="card">
                        <div class="card-header">
                            <p class="mb-2 fw-bolder">HAOP Approval</p>
                        </div>
                        <div class="card-body">
        ...
        <div class="offcanvas offcanvas-end" id="hod-approval" aria-hidden="true">
            <div class="offcanvas-header mb-0">
                <h5 class="offcanvas-title">Head of Department Approval</h5>
                <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </div>
            <hr class="mx-n1">
            <div class="offcanvas-body flex-grow-1">
                <form wire:submit="hodApproval">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="invoice-message" class="form-label">HOD Approval Remark</label>
                        <textarea class="form-control" wire:model="hod_approved_note" id="invoice-message" cols="3" rows="3" required></textarea>
